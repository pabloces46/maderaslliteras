...
<head>
    ...
    <title>LLITERAS PLACAS Y MADERAS</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <img src="../Estilos/images/logo.jpg" alt="" width="320px" >
                    ...
                    ?>
                        ...
                        <form role="form" action="process/checklogin.php" method="post" onsubmit="return campo_vacio(this)">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="PIN" name="password" type="password" value="">
                                </div>
