                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                  ...
                                  <div class="table-responsive">
                                  	<table class="table">
                                        <tbody>
                                          <tr>
                                            <td>Codigo:</td>
                                            <td>
                                                <input type="text" name="codigo" id="codigo" value="" class="form-control" require>
                                    ...
                                    <button type="submit" id="agregar" class="btn btn-primary btn-lg btn-block">Agregar Artículo</button>
                                  </div> <!-- /.row col-3 -->
